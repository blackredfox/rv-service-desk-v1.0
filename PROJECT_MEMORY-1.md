...
- No “DIY advice”, no coaching the user how to test beyond the structured questions required by diagnostic form logic.
...
## 10) Prompt Architecture & Version Truth

### 10.1 Customer prompt (source of truth)
...
### 10.3 Important note on web-agent behavior
A web-agent may:
...
## 12) Quality Gates (Must-have)

### 12.1 Determinism & validation
...
### 12.2 Testing expectations (minimum)
- Unit tests: mode transitions, validators, prompt selection, language gating.
